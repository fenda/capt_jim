...
if (function_exists('add_theme_support')) {
    ...
    add_image_size('blog-post', 675, 360, true);
...
function html5blank_header_scripts() {
    if ($GLOBALS['pagenow'] != 'wp-login.php' && !is_admin()) {
        if (HTML5_DEBUG) {
            ...
            wp_register_script('jquery', 'https://code.jquery.com/jquery-2.2.4.min.js', array(), '1.11.1');
            wp_register_script('conditionizr', get_template_directory_uri() . '/js/lib/conditionizr-4.3.0.min.js', array(), '4.3.0');
            wp_register_script('modernizr', get_template_directory_uri() . '/js/lib/modernizr.js', array(), '2.8.3');
            wp_register_script('stellar', get_template_directory_uri() . '/js/lib/stellar.min.js', array(), '2.8.3');
...
function load_fonts() {
    wp_register_style('openSans', 'https://fonts.googleapis.com/css?family=Open+Sans:400,400i,600,600i,700,700i');
...
{
    global $post;
    return '<a class="view-article button" href="' . get_permalink($post->ID) . '">' . __('Read more', 'html5blank') . '</a>';
}
